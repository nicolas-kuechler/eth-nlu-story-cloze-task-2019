...
def main(topn=1):
    ...
    ## load data
    model = Doc2Vec.load('./code/dataset_generation/story_similarity.model')
    ...
    pd.DataFrame(res).to_csv(f'data/train_stories_top_{topn}_most_similar_stories.csv', header=None, index=None)
